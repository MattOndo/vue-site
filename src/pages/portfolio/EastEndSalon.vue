<template>
  <Layout>
    <header class="cf">
      <h1 class="mb0">East End Salon</h1>
      <div class="mb3">
        <span class="f7 fw1">Single-Page Brochure Site</span> //
        <span class="f7 fw1">Lead Developer</span> //
        <span class="f7 fw1">2014</span>
      </div>
    </header>
      ...
      script: [
        {
          ...
          '@type': 'WebSite',
          name: 'East End Salon - Project - Matt Ondo',
          url: '${currentUrl}'
        }`
        }
      ],
